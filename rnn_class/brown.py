...
def get_sentences_with_word2idx_limit_vocab(n_vocab=2000, keep_words=KEEP_WORDS):
  ...
  word_idx_count = {     # 計算每個idx 出現的次數
    0: float('inf'),   # 表正無窮大;  float('-inf') 表負無窮大
    1: float('inf'),
  }
...
def main():
  ...
  print('sentences[0:3]:', sentences[0:3])

  print('type(word2idx):', type(word2idx))
